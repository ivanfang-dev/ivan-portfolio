  ...
  const educationEntries: TimelineEntry[] = [
    {
      ...
      Coursework includes Programming in C++, Software Construction, and Algorithms & Complexity.
    ...
    },
    {
      ...
      Developed discipline, leadership, and teamwork under pressure.`,
      type: 'education',
    },
    {
      id: 'hwa-chong',
      ...
      period: '2020 – 2022',
      description: `Completed pre-university education, achieved a perfect score (90/90RP), placing top 10% nationwide.
      Held leadership roles in student government and extracurricular organizations.`,
      type: 'education',
    },
  ];
